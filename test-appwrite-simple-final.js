...
async function testAppwriteSimpleFinal() {
    console.log('========================================');
    console.log('    Simple Final Appwrite Test');
    console.log('========================================\n');
    ...
    try {
        ...
        try {
            ...
            if (error.code === 404) {
                ...
                console.log('   This is a JWT token issue. Your API key might be a server key.');
            }
        }
        console.log();
...
// Run the test
testAppwriteSimpleFinal().catch(console.error);
