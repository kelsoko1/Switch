...
import GroupPaymentsTab from '../../components/wallet/GroupPaymentsTab'

const KiongoziWallet = () => {
  const { user } = useAuth()
  const { 
    wallet, 
    stats, 
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Kiongozi Wallet</h1>
            <p className="mt-2 text-gray-600">Manage your groups and process member payments</p>
          </div>
        </div>
      </div>

      {/* Wallet Overview Card */}
      <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-medium opacity-90">Group Management Balance</h2>
            <p className="text-3xl font-bold mt-2">{formatCurrency(wallet.balance)}</p>
            <p className="text-sm opacity-75 mt-1">Available for group operations</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Pay group members</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Manage group funds</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Fund operations</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">Personal Goals</h3>
                <p className="text-sm text-gray-500">My savings targets</p>
              </div>
            </div>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {formatCurrency(stats.totalDepositAmount * 0.8)} {/* Mock data */}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-500">Group Collections</p>
                <p className="text-lg font-semibold text-gray-900">
                  {formatCurrency(stats.totalDepositAmount * 1.2)} {/* Mock data */}
                </p>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'overview' && (
        <div className="bg-white rounded-lg shadow-md">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Recent Group Activity</h3>
          </div>
          <div className="divide-y divide-gray-200">
            {recentTransactions.length > 0 ? (
              ...
              <div className="px-6 py-8 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Start by processing payments for your groups.</p>
              </div>
            )}
          </div>
        </div>
