...
const AdminWallet = () => {
  ...
  const fetchSystemStats = async () => {
    try {
      // This would be a new API endpoint for system statistics
      // const response = await adminAPI.getSystemStats()
      // setSystemStats(response.data.data.stats)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-600">System administration and financial oversight</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-medium opacity-90">System Balance</h2>
            <p className="text-3xl font-bold mt-2">{formatCurrency(wallet.balance)}</p>
            <p className="text-sm opacity-75 mt-1">Available for system operations</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">All Contributions</h3>
                <p className="text-sm text-gray-500">System-wide view</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">System Deposit</h3>
                <p className="text-sm text-gray-500">Add system funds</p>
              </div>
            </div>
          </button>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {formatCurrency(systemStats.systemBalance)}
                </p>
              </div>
            </div>
          </div>
